"""
Django settings for SportGoodsStore project.
...
WSGI_APPLICATION = 'SportGoodsStore.wsgi.application'
...
ACCOUNT_LOGOUT_REDIRECT = 'shop:product_list'
SITE_ID = 1
...
CELERY_BROKER_URL = os.getenv('CELERY_BROKER_URL', 'amqp://guest:password@rabbitmq//')
